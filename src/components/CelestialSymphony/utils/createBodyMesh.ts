...
const createStar = (body: BodyData, initialProps: MaterialProperties[string]) => {
    ...
    const coreMaterial = new THREE.ShaderMaterial({
        uniforms: {
            ...
            useNormalMap: { value: !!paths?.normal && (initialProps.normalScale ?? 0) > 0 },
            normalScale: { value: new THREE.Vector2(initialProps.normalScale ?? 1.0, initialProps.normalScale ?? 1.0) },
            useDisplacementMap: { value: !!paths?.displacement && (initialProps.displacementScale ?? 0) > 0 },
            displacementScale: { value: initialProps.displacementScale },
            useSpecularMap: { value: !!paths?.specular && (initialProps.specularIntensity ?? 0) > 0 },
            specularIntensity: { value: initialProps.specularIntensity },
            shininess: { value: initialProps.shininess },
            useAoMap: { value: !!paths?.ambient && (initialProps.aoMapIntensity ?? 0) > 0 },
    ...
    if (body.name === 'Viridis') {
        material = new THREE.ShaderMaterial({
            uniforms: {
                ...
                useNormalMap: { value: !!normalMap && (initialProps.normalScale ?? 0) > 0 },
                useDisplacementMap: { value: !!displacementMap && (initialProps.displacementScale ?? 0) > 0 },
                useSpecularMap: { value: !!specularMap && (initialProps.specularIntensity ?? 0) > 0 },
                useAoMap: { value: !!aoMap && (initialProps.aoMapIntensity ?? 0) > 0 },
            },
